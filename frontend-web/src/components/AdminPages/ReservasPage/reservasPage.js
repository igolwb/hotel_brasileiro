  ...
  return (
    <>
      ...
      <div className="reservas-container">
              ...
              <>
                {currentReservas.map((reserva) => (
                  <tr key={reserva.id}>
                    ...
                    <td>
                      <button 
                      className="btn-trash" onClick={() => abrirModal(reserva)}>
                         <img src={delete_btn} alt="Excluir" style={{ width: 28, height: 28 }}/>
                      </button>
                      <button 
                      className="btn-image" onClick={() => navigate(`/admin/reservas/${reserva.id}`)}>
        ...
        <button className="btn-add" onClick={() => navigate(`/admin/reservas/addReserva`)}>Adicionar
        </button>
