...
import './formReserva.css'; // Crie este arquivo copiando o formQuarto.css e ajustando as classes
...
function AddReserva() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await createReserva(form); // Adiciona a nova reserva
      navigate('/admin/reservas'); // Redireciona para a página de reservas
    } catch (error) {
